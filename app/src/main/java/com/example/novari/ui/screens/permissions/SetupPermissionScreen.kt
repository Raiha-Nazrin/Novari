...
fun SetupPermissionScreen(
    ...
    Column(
        ...
        val onSmsAction = remember(onPermissionAction) { { onPermissionAction(PermissionType.SMS) } }
        val onNotificationsAction = remember(onPermissionAction) { { onPermissionAction(PermissionType.NOTIFICATIONS) } }
    ...
    Column(
        ...
        Row(
            ...
            Text(
                ...
                color = if (isDenied) NovariColors.Error else Color(0xFF666666)
            )

            AnimatedContent(targetState = status, label = "permissionAction") { targetStatus ->
                ...
                val actionTint = if (targetDenied) NovariColors.Error else Color(0xFF14736D)
